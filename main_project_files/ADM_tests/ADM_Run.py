...
num_gen_per_iter = [10]  # number of generations per iteration
    ...
    for n_obj, n_var in zip(n_objs, n_vars):
        for problem_name in problem_names:
            ...
            cf = generate_composite_front(
                int_rvea.population.objectives, int_probrvea.population.objectives
            )
            ...
            for i in range(L):
                ...
                cf = generate_composite_front(
                    cf, int_rvea.population.objectives, int_probrvea.population.objectives
                )
