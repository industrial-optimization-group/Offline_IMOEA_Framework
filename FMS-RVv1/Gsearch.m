...
muc = 30;    % Index of Simulated Binary Crossover (tunable)
...
%     parent = population;
    ...
    for i = 1 : 2: pop
         ...
         p1=Dparent1(i);
         p2=Dparent1(i+1);
        [child(count).rnvec,child(count+1).rnvec]=Evolve.crossover(parent(p1).rnvec,parent(p2).rnvec,muc,Cdim,0,L,U);
